// action types are constants that describe the action
...
export const GET_GIANT_BOMB_DATA_BEGIN = 'Begin fetching Giant Bomb data';
export const GET_GIANT_BOMB_DATA_SUCCESS = 'Giant Bomb data fetched successfully';
export const GET_GIANT_BOMB_DATA_FAILURE = 'Failed to fetch Giant Bomb data';
export const GET_GOOGLE_BOOKS_DATA_BEGIN = 'Begin fetching Google Books data';
export const GET_GOOGLE_BOOKS_DATA_SUCCESS = 'Google Books data fetched successfully';
export const GET_GOOGLE_BOOKS_DATA_FAILURE = 'Failed to fetch Google Books data';
...
export const SET_IS_SIDEBAR_VISIBLE = 'Show or hide sidebar';
